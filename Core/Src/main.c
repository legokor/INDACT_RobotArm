...
/* USER CODE BEGIN PV */
ADC_HandleTypeDef* hadc[3]={&hadc1, &hadc2, &hadc3};
/* USER CODE END PV */
...
uint32_t buffer1[ADC_BUFFERlENGTH]={0};
uint32_t buffer2[ADC_BUFFERlENGTH]={0};
uint32_t buffer3[ADC_BUFFERlENGTH]={0};
/* USER CODE END 0 */
