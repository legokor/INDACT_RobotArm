...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin : ESTOP_EXTI0_Pin */
  GPIO_InitStruct.Pin = ESTOP_EXTI0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ESTOP_EXTI0_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : Servo2_button_curl_Pin Servo2_button_straighten_Pin Servo3_button_curl_Pin Servo3_button_straighten_Pin
                           Phi_Limit_sw_1_Pin Phi_Limit_sw_2_Pin Z_Limit_sw_1_Pin Z_Limit_sw_2_Pin
