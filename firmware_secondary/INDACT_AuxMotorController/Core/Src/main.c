...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pins : Alpha_Btn_1_Pin Alpha_Btn_2_Pin Beta_Btn_1_Pin Beta_Btn_2_Pin */
  GPIO_InitStruct.Pin = Alpha_Btn_1_Pin|Alpha_Btn_2_Pin|Beta_Btn_1_Pin|Beta_Btn_2_Pin;
